  ...
  return (
    <div className="container mx-auto overflow-x-hidden p-8 text-justify">
      ...
      <section className="mb-12">
        ...
        <p>Total Investment Value: $100,000</p>
        <p>Leverage: 3.5x</p>

        <div className="w-full overflow-x-auto">
          <table className="mt-6 min-w-full table-auto border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-100">
                ...
                <th className="border border-gray-300 px-4 py-2">
                  Estimate Gains with 3.5x Leverage
                </th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td className="border border-gray-300 px-4 py-2">Aggressive</td>
                ...
                <td className="border border-gray-300 px-4 py-2">$31,500</td>
                <td className="border border-gray-300 px-4 py-2">22%</td>
                <td className="border border-gray-300 px-4 py-2">$7,025</td>
              </tr>
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2">15%</td>
                <td className="border border-gray-300 px-4 py-2">$3,192</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-4 py-2"></td>
                ...
                <td className="border border-gray-300 px-4 py-2">$1,050</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-4 py-2"></td>
                <td className="border border-gray-300 px-4 py-2"></td>
                ...
                <td className="border border-gray-300 px-4 py-2">$31,500</td>
                <td className="border border-gray-300 px-4 py-2">15%</td>
                <td className="border border-gray-300 px-4 py-2">$4,725</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-4 py-2"></td>
                <td className="border border-gray-300 px-4 py-2">BTST</td>
                <td className="border border-gray-300 px-4 py-2">25%</td>
                <td className="border border-gray-300 px-4 py-2">Nifty 50</td>
                <td className="border border-gray-300 px-4 py-2">15%</td>
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2">$31,500</td>
                <td className="border border-gray-300 px-4 py-2">25%</td>
                <td className="border border-gray-300 px-4 py-2">$7,875</td>
              </tr>
              <tr>
                <td className="border border-gray-300 px-4 py-2"></td>
      ...
      <section className="mb-12">
        ...
        <Image
          height={1000}
          width={1000}
          src="/crowdstrikeholdings.jpeg"
          alt="Crowdstrike Holdings Chart"
          className="my-6 h-64 w-[100%] md:h-[40rem]"
        />
        ...
        <p className="mb-4 text-gray-800">
          ...
          billions of dollars in Nvidia&apos;s chips. These chips possess the
          computational power behind generative AI technology, enabling the
          rapid generation of human-like text, video, and code.
        </p>
        <p className="mb-4 text-gray-800">
        ...
        <p className="mb-4 text-gray-800">
          ...
          for the emerging field of hybrid computing. Moreover, this
          collaboration positions NVIDIA as a frontrunner in the development of
          tools and resources for hybrid HPC.
        </p>
        <p className="mb-4 text-gray-800">
        ...
        <p className="mb-4 text-gray-800">
          ...
          Revenue surged 13% year-over-year to $143.3 billion.
        </p>
        <p className="mb-4 text-gray-800">
          Operating income stood at $15.3 billion, significantly higher than the
          guidance range between $8 billion to $12 billion while EPS surpassed
          expectations at 98 cents. Revenue stemming from Amazon Web Services
          (AWS) showcased the strongest growth in four quarters as it surged 17%
          to $25 billion. Ad revenue grew 24% to $11.8 billion while revenue
          from third-party seller services rose 16% to $34.6 billion.
        </p>
        <p className="mb-4 text-gray-800">
          Ad revenue growth was driven by strength in Sponsored products due to
          improvements in relevancy and measurement.
        </p>
        <p className="mb-4 text-gray-800">
        ...
        <p className="mb-4 text-gray-800">
          ...
          reaching $58 billion according to analyst estimates.
        </p>
        <p className="mb-4 text-gray-800">
        ...
        <p className="mb-4 text-gray-800">
          ...
          billion, though slightly missing expectations.
        </p>
        <p className="mb-4 text-gray-800">
        ...
        <p className="mb-4 text-gray-800">
          ...
          doubling of net income to $13.5 billion, reflecting the company&apos;s
        ...
        <p className="mb-4 text-gray-800">
          ...
          low-priced, unbranded items.
        </p>
        <p className="mb-4 text-gray-800">
          The company also expects operating income to remain steady in the
          third quarter.
        </p>
        <p className="mb-4 text-gray-800">
          Kuiper, a subsidiary of Amazon, is scheduled to launch its first
          production satellites in 2024, with Amazon targeting the 400 million
          to 500 million households without broadband connectivity.
        </p>
        ...
        <p className="mb-4 text-gray-800">
          ...
          expectations in its Azure Cloud business.
        </p>
        <p className="mb-4 text-gray-800">
          Despite this, overall revenues grew by over 15% YoY to $64.7 billion,
          net income increased by over 10% YoY to $22 billion, and net cash from
          operations surged 29% YoY to $37.2 billion.
        </p>
        <p className="mb-4 text-gray-800">
          ...
          billion, with Azure explicitly increasing by 29%.
        </p>
        <p className="mb-4 text-gray-800">
          Additionally, Microsoft announced plans to increase capital
          expenditures for the fiscal year 2025.
        </p>
        <p className="mb-4 text-gray-800">
          CEO Satya Nadella and CFO Amy Hood suggested that this higher CAPEX
          spending reflects a strong demand for AI capabilities. They emphasized
          the architectural alignment between cloud and AI infrastructure,
          indicating that any excess AI capacity could be monetized through
          cloud computing services. This perspective aligns with similar
          statements made by Alphabet&apos;s leadership.
        </p>
        <p className="mb-4 text-gray-800">
...
export default AggressivePortfolio;
